...
/**
 * Renders a skeleton for a blog post item.
 *
 * @param variant - The variant of the skeleton (default: 'vertical').
 * @param sx - The additional styles for the skeleton.
 * @param other - Additional props for the skeleton.
 */
...
/**
 * Renders a skeleton component for the post details.
 * @param other - Additional props for the Stack component.
 */
