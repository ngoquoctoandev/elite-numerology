...
export function useNavData() {
  ...
  const data = useMemo(
    () => [
      ...
      {
        title: t('numerology.menu'),
        icon: <Iconify icon="solar:atom-bold-duotone" />,
        path: paths.numerology.map.elite,
        children: [
          {
            subheader: t('numerology.menu'),
            items: [
              {
                title: t('numerology.eliteMap'),
                path: paths.numerology.map.elite,
              },
              {
                title: t('numerology.kidMap'),
                path: paths.numerology.map.kid,
              },
            ],
          },
        ],
